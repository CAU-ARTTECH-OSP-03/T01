...
def mainmenu():
    ...
    while menu:
        ...
        titletext = gameDisplay.blit(titleImg, (350, 100))
        rungameButton = Button(runstartImg, 90, 260, 260, 110, clickStartImg, 180, 260, rungame1)
        bellgameButton = Button(bellstartImg, 370, 260, 260, 110, clickStartImg, 460, 260, handbell1)
        ddrgameButton = Button(ddrstartImg, 650, 260, 260, 110, clickStartImg, 740, 260, ddrgame1)
        quitButton = Button(quitImg, 850, 400, 65, 70, clickQuitImg, 840, 400, quitgame)
        pygame.display.flip()
