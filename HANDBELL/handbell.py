...
# bground
bground_img = pygame.image.load('./image/bellbg.png')
bground = pygame.transform.scale(bground_img, (1000, 560))
endingbg = pygame.image.load('bellending.png')
...
def main():
    ...
    # bellimage
    bell1_img = pygame.image.load('./image/doredf.png')
    bell2_img = pygame.image.load('./image/doreleft.png')
    bell3_img = pygame.image.load('./image/doreright.png')

    bell4_img = pygame.image.load('./image/mipadf.png')
    bell5_img = pygame.image.load('./image/mipaleft.png')
    bell6_img = pygame.image.load('./image/miparight.png')

    bell7_img = pygame.image.load('./image/solradf.png')
    bell8_img = pygame.image.load('./image/solraleft.png')
    bell9_img = pygame.image.load('./image/solraright.png')

    bell10_img = pygame.image.load('./image/sidodf.png')
    bell11_img = pygame.image.load('./image/sidoleft.png')
    bell12_img = pygame.image.load('./image/sidoright.png')
